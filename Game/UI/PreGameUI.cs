...
internal class PreGameUI : UIBase
{
    ...
    internal override void OnCreate()
    {
        ...
        foreach(StratagemEntityBase stratagemEntityBase in _stratagemEntities.Values)
        {
            _stratagemList.Controls.SetChildIndex(stratagemEntityBase.MainPanel.Parent, stratagemEntityBase.UiID);
        }
